...
| `docs` | 2 | Markdown and Mermaid authoring rules for agent-written documents | `vscode`, `claude-code` | No |
...
- **docs** ships `markdown-craft` — stack-agnostic rules for the Markdown an agent writes: one home per fact, diagram-first flows, link hygiene, and a Mermaid reference loaded before any diagram is authored.
